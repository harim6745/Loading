...
public class Health_review_1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_honey_review_1);
        ...
        task.execute("http://" + IP_ADDRESS + "/show_review_health_hr.php", "");
        ...
        WriteReviewButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(Health_review_1.this, Health_review_write.class);
...
*/
    ...
    private class GetData extends AsyncTask<String, Void, String>{
        ...
        protected void onPreExecute() {
            ...
            progressDialog = ProgressDialog.show(Health_review_1.this,
